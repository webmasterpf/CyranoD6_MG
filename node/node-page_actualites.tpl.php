...
<div class="node <?php print $classes; ?>" id="node-<?php print $node->nid; ?>">
    <div class="node-inner">
         <div id="global-content-node">
            ...
            <h1 class="titre_page-actu"><?php print $title; ?></h1>
            <?php endif; ?>
         ...
         */?>
        <div id="colonne-1" class="col1_layout_295_385_295">
           
             <?php
              global $theme_path;
              include ($theme_path.'/includes/inc_actu_europe.php');
              ?>
        ...
        <div id="colonne-2" class="col2_layout_295_385_295">
                <?php
              global $theme_path;
              include ($theme_path.'/includes/inc_actu_annonce-rp1.php');
              ?>
        ...
        <div id="colonne-3" class="col3_layout_295_385_295">
            ...
            <?php
              global $theme_path;
              include ($theme_path.'/includes/inc_actu_vdl.php');
              ?>
