...
<div class="node <?php print $classes; ?>" id="node-<?php print $node->nid; ?>">
    <div class="node-inner">
        ...
        <div id="colonne-1" class="col1_layout_200_590_200">
            ...
            <?php if ($node->field_erreur_illus[0]['view']): ?>
            <div id="erreur-illustration">
                    <?php  print $node->field_erreur_illus[0]['view']  ?>
            </div>
            <?php endif;?>
        ...
        <div id="colonne-3" class="col3_layout_200_590_200">
            ...
            <?php if ($node->field_erreur_actus[0]['view']): ?>
            <div id="nom-css">
                    <?php  print $node->field_erreur_actus[0]['view']  ?>
            </div>
            <?php endif;?>
