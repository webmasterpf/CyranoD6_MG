...
if (!empty($view->result)) {
  ...
  $output = '<div id="actu-liste-europe"><h3 class="classe-h3">'.$view->get_title().'</h3>' .$view->preview($viewdisplay_ag1).'</div>';
...
elseif (empty($view->result)) {
    //Formatage du texte vide,ajout du titre de la vue
     $outputEmpty = '<div id="actu-liste-europe"><h3 class="classe-h3">'.$view->get_title().'</h3>' .$emptyText.'<br>'.$emptyTextVue.'</div>';
